...
---- METRIC TO FIND THE TOTAL COST, TOTAL SALES AND DERIVE PROFIT --------- 0 rows
...
---- A METRIC TO MEASURE THE INVENTORY BALANCE OF A PRODUCT BY YEAR AND MONTH ----- 0 rows
SELECT DP.MODELNAME,
       DD.CALENDARYEAR,
       DD.MONTHNUMBEROFYEAR,
       SUM(UNITSBALANCE)
...
---------- METRICS TO SEE SOME METRICS IN THE CALL CENTRE WITH RESPECT TO YEAR, MONTH, WAGETYPE, SHIFT AND GRADE ---------
SELECT DD.CALENDARYEAR,
       DD.MONTHNUMBEROFYEAR,
       FCC.WAGETYPE,
       FCC.SHIFT,
